// src/app/(main)/advertiser/[advertiserId]/support/create/page.tsx
import SupportCreateForm from "@/components/support/create/SupportCreateForm";

const SupportCreatePage = async( 
    props:{
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-50/80 via-teal-50/60 to-cyan-50/40 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-teal-300/10 to-emerald-300/10 rounded-full blur-3xl"></div>
            </div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 mt-4 text-lg max-w-2xl mx-auto">
                            お困りのことがございましたら、お気軽にお問い合わせください。迅速に対応いたします。
                        </p>
                    </div>
                    ...
                    <div className="absolute bottom-20 right-16 w-5 h-5 bg-gradient-to-br from-emerald-300/30 to-teal-400/30 rounded-full blur-lg animate-pulse"></div>
                </div>
            </div>
        </div>
    )
